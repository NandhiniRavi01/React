...
import "../css/Sidebar.css"; // Ensure your CSS is linked
  ...
  return (
    <div>
      ...
      <aside className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
        ...
        <ul >
        <li>
        <Link to="/" className="sidebar-btn1 active" onClick={closeSidebar}>
          <i className="fas fa-home icon" style={{ marginRight: '10px',color:"green" }}></i> Dashboard
          </Link>
        </li>
            <li>
